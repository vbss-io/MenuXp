export const menuItemCardLayoutGlobalStyles = `
  ...
  .menu-item-card.layout-menuxp .discount-chip {
    background: var(--restaurant-primary-color) !important;
    border-radius: 12px !important;
  }

  .menu-item-card.layout-menuxp .menu-item-image {
    border-radius: 12px 12px 0 0 !important;
  }

  .menu-item-card.layout-menuxp .menu-item-content {
    padding: 16px !important;
  }

  .menu-item-card.layout-menuxp .menu-item-name {
    color: hsl(0, 0%, 0%) !important;
  }

  .menu-item-card.layout-menuxp .menu-item-description {
    color: hsl(0, 0%, 50%) !important;
  }

  .menu-item-card.layout-menuxp .menu-item-price .discount-price {
    color: var(--restaurant-primary-color) !important;
  }

  .menu-item-card.layout-menuxp .menu-item-price .current-price {
    color: var(--restaurant-primary-color) !important;
  }

  .menu-item-card.layout-menuxp .menu-item-price .original-price {
    color: hsl(0, 0%, 50%) !important;
  }

  .menu-item-card.layout-menuxp .add-to-cart-button {
    background: var(--restaurant-primary-color) !important;
