...
import {
  ...
  PhoneScreen,
  PhoneStatusBar
} from '@/components/ui/phone-mockup'
...
export const Hero: React.FC = () => {
  ...
  const mockups = [
    { alt: 'Template Clássico', src: '/images/menu-layouts/01.png' },
    { alt: 'Template Dark', src: '/images/menu-layouts/02.png' },
    { alt: 'Template Clean', src: '/images/menu-layouts/03.png' },
    { alt: 'Template Brutalista', src: '/images/menu-layouts/04.png' }
  ]
