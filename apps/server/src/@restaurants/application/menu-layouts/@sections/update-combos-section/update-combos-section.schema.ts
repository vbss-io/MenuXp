...
export const UpdateCombosSectionSchema = z.object({
  ...
  comboIds: z
    ...
    .refine((val) => val === null || val === undefined || (Array.isArray(val) && val.length > 0), {
      message: 'comboIds must be null or a non-empty array'
    })
})

export type UpdateCombosSectionType = z.infer<typeof UpdateCombosSectionSchema>
