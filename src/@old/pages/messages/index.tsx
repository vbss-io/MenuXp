import { AppContext } from '@/@old/contexts/AppContext'
import { AlertCircle, Check, CheckCheck, RefreshCw } from 'lucide-react'
...
export const Messages = () => {
  ...
  return (
    <div className="p-6">
      ...
      {error && <div className="mb-4 p-3 bg-error-100 text-error-800 rounded-sm border border-black">{error}</div>}
              ...
              .map((message) => (
                <li key={message.id} className="p-4 hover:bg-bg-light transition-colors">
                  <div className="flex items-start">
                    <div
                      className={`mt-1 rounded-sm h-2 w-2 flex-shrink-0 border border-black ${
                        message.status === 'sent'
                          ? 'bg-gray-400'
                    ...
                    <div className="ml-4 flex-1">
                      <div className="flex justify-between items-start">
                        <div>
                          <h3 className="text-subtitle font-medium text-text-primary">Pedido #{message.order_id}</h3>
                        ...
                        <div className="flex items-center">
                          <span className="text-subtitle text-text-secondary mr-2">
