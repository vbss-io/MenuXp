import OrderCard from '@/@old/components/orders/OrderCard'
import OrderDetailModal from '@/@old/components/orders/OrderDetailModal'
import StatusConfirmModal from '@/@old/components/orders/StatusConfirmModal'
...
export const Orders = () => {
  ...
  const confirmStatusChange = async () => {
    ...
    try {
      ...
      setErrorMessage(
        `Falha ao atualizar status do pedido #${pendingStatusChange.orderId}. Clique para tentar novamente.`
      )
    } finally {
  ...
  return (
    <div className="p-6">
      ...
      {errorMessage && (
        <div className="toast-error mb-4 cursor-pointer" onClick={() => setErrorMessage(null)}>
          {errorMessage}
        </div>
      )}
