          ...
          {!showCancelConfirm ? (
            <>
              ...
              <div className="mb-6">
                ...
                <div className="bg-bg-light p-4 rounded-sm border border-black">
                  <span
                    className={`inline-block px-3 py-1 rounded-sm text-subtitle font-medium border border-black ${
            ...
            <div className="text-center">
              <div className="mb-6">
                ...
                <h3 className="text-body font-medium text-text-primary mb-2">Confirmar Cancelamento</h3>
