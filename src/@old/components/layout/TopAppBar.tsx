                ...
                {searchResults.map((order) => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        <div className="font-medium text-text-primary text-body">Pedido #{order.id}</div>
                        <div className="text-subtitle text-text-secondary">{order.customer_name}</div>
                        <div className="text-xs text-gray-500">{order.customer_phone}</div>
                      </div>
                      <div className="text-right">
                        <div
                          className={`text-xs px-2 py-1 rounded-sm border border-black ${
                        ...
                        <div className="text-xs text-gray-500 mt-1">R$ {order.total.toFixed(2)}</div>
                      </div>
                    </div>
                  </button>
                ))}
