...
export const Filters = ({ filters, onFiltersChange, onReset, isExpanded }: FiltersProps) => {
  const handleFilterChange = (key: keyof CategoryFilters, value: string | number | boolean) => {
    onFiltersChange({
      ...filters,
      [key]: value
    })
