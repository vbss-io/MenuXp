...
import {
  ...
  FeatureList,
  FeatureText
} from '@/presentation/components/ui/landing-page/hero/components/feature-list'
import { Highlight } from '@/presentation/components/ui/landing-page/hero/components/highlight'
import {
  PhoneBadge,
  PhoneContent,
  PhoneFrame,
      ...
      <SectionContent>
        <SectionGrid>
          <SectionTextContent>
            ...
            >
              <S.HeroTitle>
                Seu app de pedidos <Highlight size="2.5rem">sem taxas</Highlight> e com{' '}
                <Highlight size="3rem">IA e Gamificação</Highlight>
              </S.HeroTitle>
              <S.HeroDescription>
