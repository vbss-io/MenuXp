        ...
        <div className="p-3 space-y-3">
          ...
          <div className="space-y-1">
            <div className="flex items-start gap-2 text-sm">
              <ShoppingCart className="w-4 h-4 text-black/60 mt-0.5" />
              <p className="text-black/80">{order.itemsSummary}</p>
            </div>
            {order.notes && order.notes.length > 0 && (
              <div className="flex flex-wrap gap-1 pl-6">
                {order.notes.map((n, i) => (
                  <span
                    key={i}
                    className="px-2 py-0.5 rounded bg-yellow-50 border border-yellow-200 text-[11px] font-semibold tracking-wide"
                  >
                    {n.toUpperCase()}
                  </span>
                ))}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-black/70">{order.place.label}</span>
            </div>
          </div>
